...
namespace CateringEcommerce.BAL.Common.Admin
{
    public class AdminPartnerRequestRepository : IAdminPartnerRequestRepository
    {
        ...
        public AdminPartnerRequestRepository(string connectionString)
        {
        ...
        public AdminPartnerRequestListResponse GetAllPartnerRequests(AdminPartnerRequestListRequest request)
        {
            ...
            response.TotalCount = Convert.ToInt32(_db.ExecuteScalar(countQuery, parameters.ToArray()));
            ...
            // Execute query
            var dataTable = _db.Execute(queryBuilder.ToString(), parameters.ToArray());
        ...
        private PartnerRequestStats GetPartnerRequestStats()
        {
            ...
            var dataTable = _db.Execute(query);
        ...
        public AdminPartnerRequestDetail? GetPartnerRequestById(long ownerId)
        {
            ...
            var dataTable = _db.Execute(query, parameters);
        ...
        public bool UpdatePriority(long ownerId, string priority, long adminId)
        {
            try
            {
                var updateQuery = @"
        ...
        public List<PartnerActionLog> GetActionLog(long ownerId)
        {
            ...
            var query = @"
                ...
                LEFT JOIN t_sys_admin ad ON a.c_admin_id = ad.c_admin_id
        ...
        public bool LogAction(long ownerId, long adminId, string actionType, string? oldStatus, string? newStatus, string? remarks, string? ipAddress)
        {
            try
            {
                var query = @"
                    ...
                    (c_ownerid, c_admin_id, c_action_type, c_old_status, c_new_status, c_remarks, c_ip_address, c_action_date)
                    VALUES
        ...
        public PartnerCommunicationResponse SendCommunication(PartnerCommunicationRequest request, long adminId)
        {
            ...
            try
            {
                ...
                var query = @"
                    ...
                    (c_ownerid, c_admin_id, c_communication_type, c_subject, c_message, c_sent_to_email, c_sent_to_phone, c_email_sent, c_sms_sent, c_email_status, c_sms_status, c_sent_date)
                    VALUES
        ...
        public List<PartnerCommunicationHistory> GetCommunicationHistory(long ownerId)
        {
            ...
            var query = @"
                ...
                LEFT JOIN t_sys_admin a ON c.c_admin_id = a.c_admin_id
