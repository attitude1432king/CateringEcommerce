        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-neutral-50 border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-neutral-500">
                    ...
                    <span className="text-neutral-700 font-medium">Partner Support</span>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl font-bold text-neutral-900">Partner Support</h1>
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="bg-green-50 rounded-2xl p-8 text-center">
                    <h3 className="text-lg font-bold text-neutral-900 mb-2">Still need help?</h3>
                    <p className="text-neutral-600 mb-6">Our partner support team is available Monday–Saturday, 9 AM to 7 PM.</p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link to="/contact-us" className="px-6 py-2.5 border border-neutral-300 text-neutral-700 font-medium rounded-lg hover:border-green-400 hover:text-green-600 transition-colors">
                            Contact Us
                        </Link>
                    </div>
                </div>
