        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl font-bold text-gray-900">About ENYVORA</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm text-center">
                        ...
                        <p className="text-gray-500 text-sm">Every caterer on our platform is vetted and approved, ensuring top-quality food and service for your events.</p>
                    </div>
                    <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm text-center">
                        ...
                        <p className="text-gray-500 text-sm">We work with certified catering businesses across the country, each committed to excellence and reliability.</p>
                    </div>
                    <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm text-center">
                        ...
                        <p className="text-gray-500 text-sm">From browsing to booking, our platform makes every step smooth — so you can focus on your event, not logistics.</p>
                    </div>
                </div>
                ...
                <div className="bg-gray-900 rounded-2xl p-10 text-center">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            ...
                            <p className="text-gray-400 mt-1">Verified Caterers</p>
                        </div>
                        <div>
                            <p className="text-4xl font-bold text-white">50,000+</p>
                            <p className="text-gray-400 mt-1">Events Catered</p>
                        </div>
                        <div>
