        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-neutral-50 border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-neutral-500">
                    ...
                    <span className="text-neutral-700 font-medium">Growth Resources</span>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl font-bold text-neutral-900">Growth Resources for Partners</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="mt-12 bg-yellow-50 rounded-2xl p-10 text-center">
                    <h3 className="text-xl font-bold text-neutral-900 mb-2">Ready to grow?</h3>
                    <p className="text-neutral-600 mb-6">Apply these tips in your partner dashboard and start seeing results.</p>
