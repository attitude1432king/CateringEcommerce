        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-neutral-50 border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-neutral-500">
                    ...
                    <span className="text-neutral-700 font-medium">Careers</span>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl font-bold text-neutral-900">Join Our Team</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="max-w-3xl mx-auto text-center mb-16">
                    <h2 className="text-2xl font-bold text-neutral-900 mb-4">Why Work at ENYVORA?</h2>
                ...
                {/* Open roles */}
                <h2 className="text-xl font-bold text-neutral-900 mb-6">Open Positions</h2>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-2">
                                        <span className="bg-neutral-100 text-neutral-600 text-xs px-2.5 py-1 rounded-full">{role.team}</span>
                                        <span className="bg-neutral-100 text-neutral-600 text-xs px-2.5 py-1 rounded-full">{role.location}</span>
                                        <span className="bg-indigo-50 text-indigo-600 text-xs px-2.5 py-1 rounded-full">{role.type}</span>
                                    </div>
                                    <p className="text-neutral-500 text-sm mt-3 leading-relaxed">{role.desc}</p>
                                </div>
                ...
                <div className="bg-neutral-50 rounded-2xl p-10 text-center">
                    <h3 className="text-xl font-bold text-neutral-900 mb-2">Don't see a role that fits?</h3>
                    <p className="text-neutral-600 mb-6">We're always looking for exceptional people. Send us your resume and tell us how you can contribute.</p>
