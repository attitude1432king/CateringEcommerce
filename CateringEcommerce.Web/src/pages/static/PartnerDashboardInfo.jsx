        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-neutral-50 border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-neutral-500">
                    ...
                    <span className="text-neutral-700 font-medium">Partner Dashboard</span>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl font-bold text-neutral-900">Your Partner Dashboard</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <h2 className="text-2xl font-bold text-neutral-900 text-center mb-10">Dashboard Features</h2>
                ...
                <div className="bg-blue-50 rounded-2xl p-10 text-center">
                    <h3 className="text-xl font-bold text-neutral-900 mb-2">Already a partner?</h3>
                    <p className="text-neutral-600 mb-6">Log in to your partner account to access your full dashboard.</p>
