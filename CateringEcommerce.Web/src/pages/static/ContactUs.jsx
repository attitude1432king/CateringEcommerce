        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-neutral-50 border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-neutral-500">
                    ...
                    <span className="text-neutral-700 font-medium">Contact Us</span>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div>
                        ...
                        <div className="mt-10 bg-neutral-50 rounded-xl p-5">
                            <p className="text-sm text-neutral-500">Support hours: Monday–Saturday, 9 AM – 7 PM IST</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${errors.name ? 'border-red-400' : 'border-neutral-200'}`}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${errors.email ? 'border-red-400' : 'border-neutral-200'}`}
                                />
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className={`w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none ${errors.message ? 'border-red-400' : 'border-neutral-200'}`}
                                />
