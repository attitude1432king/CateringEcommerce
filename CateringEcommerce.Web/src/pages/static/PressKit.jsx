        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-neutral-50 border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-neutral-500">
                    ...
                    <span className="text-neutral-700 font-medium">Press Kit</span>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl font-bold text-neutral-900">Press Kit</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="max-w-3xl mb-16">
                    <h2 className="text-2xl font-bold text-neutral-900 mb-4">Company Overview</h2>
                ...
                {/* Downloads */}
                <h2 className="text-xl font-bold text-neutral-900 mb-6">Brand Assets</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    {[
                        ...
                        <div key={i} className="border border-gray-100 rounded-2xl p-6 text-center hover:border-indigo-200 hover:shadow-sm transition-all">
                            ...
                            <h3 className="font-semibold text-neutral-900 mb-1">{asset.name}</h3>
                            <p className="text-neutral-500 text-sm mb-4">{asset.desc}</p>
                            <button className="w-full py-2 border border-neutral-200 text-neutral-600 text-sm rounded-lg hover:border-indigo-400 hover:text-indigo-600 transition-colors">
                ...
                <div className="bg-indigo-50 rounded-2xl p-8 text-center">
                    <h3 className="text-lg font-bold text-neutral-900 mb-2">Press Contact</h3>
                    <p className="text-neutral-600 mb-4">For media inquiries, interviews, and additional materials, reach out to our communications team.</p>
