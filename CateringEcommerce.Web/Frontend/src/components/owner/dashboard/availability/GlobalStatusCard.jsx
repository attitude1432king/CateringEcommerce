    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="p-6">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-4 flex gap-4 animate-slide-up-delay">
                                <div className="flex items-center gap-2 text-sm group">
                                    <svg className="w-4 h-4 text-indigo-600 group-hover:scale-125 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {isOpen && (
                    <div className="mt-6 p-4 bg-indigo-50 rounded-xl border border-indigo-100 animate-expand-down">
                        <div className="flex items-start gap-3">
                            <svg className="w-5 h-5 text-indigo-600 flex-shrink-0 mt-0.5 animate-bounce-subtle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <div>
                                <p className="text-sm font-medium text-indigo-900 mb-1">Pro Tip</p>
