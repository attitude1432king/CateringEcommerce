  ...
  if (!requests || requests.length === 0) {
    return (
      <EmptyState
        ...
        message="No partner registration requests found matching your filters."
        action={{
          label: 'Clear Filters',
          onClick: onRefresh
        }}
                ...
                <td className="px-6 py-4">
                  <div className="text-sm">
                    ...
                    <div className="flex items-center text-gray-500 mt-1">
                      ...
                      <span className="text-xs">{request.ownerPhone}</span>
                    </div>
                    <div className="flex items-center text-gray-500 mt-1">
                      <Mail className="w-3 h-3 mr-1" />
                      <span className="text-xs truncate" title={request.ownerEmail}>
                        {request.ownerEmail}
                      </span>
                    </div>
                  </div>
