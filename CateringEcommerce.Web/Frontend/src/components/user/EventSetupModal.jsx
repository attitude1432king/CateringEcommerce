                    ...
                    <div className="bg-white rounded-xl p-6 border-2 border-gray-300">
                        ...
                        {!isValid && (
                            <div className={`mb-4 p-4 rounded-lg border-2 ${
                                ...
                                <div className="flex items-start gap-3">
                                    <svg className={`w-6 h-6 mt-0.5 ${difference > 0 ? 'text-orange-600' : 'text-red-600'}`} fill="currentColor" viewBox="0 0 20 20">
                        ...
                        {isLoadingCategories ? (
                            <div className="text-center py-8">
                                ...
                                <p className="text-gray-600 mt-3">Loading guest categories...</p>
                            </div>
                        ) : (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div key={category.categoryId} className="bg-gray-50 rounded-lg p-4 border-2 border-gray-200">
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex items-center gap-2">
                                                <div>
                                                    <h4 className="font-bold text-gray-900">{category.categoryName}</h4>
